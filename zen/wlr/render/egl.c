...
static void
egl_log(EGLenum error, const char *command, EGLint msg_type, EGLLabelKHR thread,
...
static int get_egl_dmabuf_modifiers(struct zn_wlr_egl *egl, int format,
...
static int
get_egl_dmabuf_modifiers(struct zn_wlr_egl *egl, int format,
    uint64_t **modifiers, EGLBoolean **external_only)
{
  *modifiers = NULL;
  *external_only = NULL;
